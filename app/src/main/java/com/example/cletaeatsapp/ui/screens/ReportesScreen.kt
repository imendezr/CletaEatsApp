                ...
                when (val state = uiState) {
                    ...
                    is ReportsUiState.Success -> {
                        ...
                        LazyColumn(
                            ...
                            // a) Inclusión de información de los clientes
                            item {
                                Card(
                                    modifier = Modifier
                                        .fillMaxWidth()
                            ...
                            // b) Inclusión de información de los restaurantes
                            item {
                                Card(
                                    modifier = Modifier
                                        .fillMaxWidth()
                            ...
                            // c) Inclusión de información de los repartidores
                            item {
                                Card(
                                    modifier = Modifier
                                        .fillMaxWidth()
                            ...
                            // d) Inclusión de información de cada pedido
                            item {
                                Card(
                                    modifier = Modifier
                                        .fillMaxWidth()
                                    ...
                                    Column(modifier = Modifier.padding(16.dp)) {
                                        ...
                                        state.pedidos.forEach { pedido ->
                                            Row(
                                                ...
                                                Text(
                                                    text = "${pedido.id}, ${pedido.estado}, ${pedido.horaRealizado}",
                                                    style = MaterialTheme.typography.bodyMedium
                                                )
                                            }
                                        }
