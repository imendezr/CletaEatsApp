...
import com.example.cletaeatsapp.viewmodel.RestaurantRegistrationViewModel
...
fun RestaurantRegistrationScreen(
    ...
    viewModel: RestaurantRegistrationViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                onClick = {
                    viewModel.register {
                        navController.navigate("restaurants/$cedulaJuridica") {
                            popUpTo("register_restaurant") { inclusive = true }
                        }
                    }
                },
                modifier = Modifier.fillMaxWidth(),
